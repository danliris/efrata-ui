...
export async function configure(aurelia) {
    aurelia.use
        ...
        .plugin("aurelia-api", config => {
            ...
            var merchandiser = "https://com-efrata-service-md-dev.azurewebsites.net/v1/";
            const dealTracking = 'https://com-efrata-service-deal-tracking-dev.azurewebsites.net/v1/';
            const sales = "https://com-danliris-efrata-sales-dev.azurewebsites.net/v1/";
            var weaving = "https://com-danliris-efrata-weaving-dev.azurewebsites.net/";
            var finance = "https://com-danliris-efrata-finance-accounting-dev.azurewebsites.net/v1/";
            var garmentProduction = "https://com-danliris-efrata-garment-dev.azurewebsites.net/";
